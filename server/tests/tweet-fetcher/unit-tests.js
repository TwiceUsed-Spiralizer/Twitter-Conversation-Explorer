...
// Modules to test
const { User, Tweet } = require('../../../server/tweet-manager/models');
const TweetManager = require('../../../server/tweet-manager');
const mongoConnectTest = require('../../../server/tweet-manager/mongo');
// Mock data
